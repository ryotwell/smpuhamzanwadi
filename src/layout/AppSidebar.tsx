...
const navItems: NavItem[] = [
  ...
  // },
  {
    ...
    name: "Batch",
    subItems: [
      { name: "Data Batch", path: "/admin/batches", pro: false },
      { name: "Tambah Batch", path: "/admin/batches/create", pro: false },
    ],
  },
  {
    icon: <Box className="w-5 h-5" />,
...
const othersItems: NavItem[] = [
  {
    ...
    name: "Persyaratan",
    subItems: [
      { name: "Persyaratan Umum", path: "/admin/requirements", pro: false },
      { name: "Pertanyaan Umum", path: "/admin/faqs", pro: false },
    ],
  },
];
